  ...
  return (
    <Grid container direction='column'>
      ...
      <Grid item container direction='row' justify='center' style={{marginTop: '15em', marginBottom: '20em'}} className={classes.rowContainer}>
        <Grid item md alignItems='center' container direction='column' style={{maxWidth: '40em'}}>
          <Grid item>
        ...
        <Grid item md alignItems='center' container direction='column' style={{maxWidth: '40em', marginTop: matchesSM ? '10em' : 0, marginBottom: matchesSM ? '10em' : 0}}>
          <Grid item>
