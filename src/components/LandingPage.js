        ...
        <Grid container direction="row" className={classes.serviceContainer} justify={matchesSM ? 'center' : undefined}>
          <Grid item style={{marginLeft: matchesSM ? 0 : '5em', textAlign: matchesSM ? 'center' : undefined}}>
            ...
            <Button 
              ...
              <span style={{marginRight: 10}}
              onClick={() => {props.setValue(1); props.setSelectedIndex(1)}}>Learn More</span>
      ...
      <Grid item> {/* Website BLOCK */}
        <Grid container direction="row" className={classes.serviceContainer} justify={matchesSM ? 'center' : undefined}>
          <Grid item style={{marginLeft: matchesSM ? 0 : '5em', textAlign: matchesSM ? 'center' : undefined}}>
            ...
            <Typography variant='subtitle1'>Optimize for search engines, built for speed.</Typography>
            <Button
              component={Link}
              to='/websites' 
              variant='outlined' 
              className={classes.learnButton}>
              <span style={{marginRight: 10}}
              onClick={() => {props.setValue(1); props.setSelectedIndex(3)}}>Learn More</span>
              <ButtonArrow width={10} height={10} fill={theme.palette.common.blue} />
            </Button>
          </Grid>
          <Grid item>
          ...
          <Grid item container style={{position: 'absolute', textAlign: matchesXS ? 'center' : 'inherit'}} direction={matchesXS ? 'column' : 'row'}>
            <Grid sm item style={{marginLeft: matchesXS ? 0 : matchesSM ? '2em' : '5em'}}>
              <Grid container direction='column' style={{marginBottom: matchesXS ? '10em' : 0}}>
                <Typography variant='h2' style={{color: 'white'}}> {/* The inline style overrides the variant */}
                  About Us
                </Typography>
                ...
                <Grid item>
                  <Button
                    ...
                    <span style={{marginRight: 10}}
                    onClick={() => props.setValue(3)}>Learn More</span>
              ...
              <Grid container direction='column'>
                ...
                <Grid item>
                  <Button
                    ...
                    style={{color: 'white', borderColor: 'white'}}>
                    <span style={{marginRight: 10}}
                    onClick={() => props.setValue(4)}>Learn More</span>
                    <ButtonArrow width={10} height={10} fill='white' />
                  </Button>
                </Grid>
              </Grid>
