...
const useStyles = makeStyles(theme => ({
  ...
  avatar: {
    ...
    [theme.breakpoints.down('sm')]: {
      ...
      widht: '20em',
      maxHeight: 300,
      maxWidth: 300  //defualt is in pixels
    }
  }
}))
...
export default function About(props) {
  ...
  return (
    <Grid container direction='column'>
      ...
      <Grid 
        item container direction={matchesMD ? 'column' : 'row'} 
        alignItems={matchesMD ? 'center' : undefined} className={classes.rowContainer} justify='space-around' style={{marginTop: '10em', marginBottom: '10em'}}>
        <Grid item>
          <Grid item container direction='column' lg style={{maxWidth: '35em'}}>
            ...
            <Grid item>
              <Typography variant='body1' paragraph style={{fontWeight: 700, fontStyle: 'italic'}} align={matchesMD ? 'center' : undefined}>We're the new kid on the block!</Typography>
      ...
      <Grid item container direction='column' className={classes.rowContainer} alignItems='center' style={{marginBottom: '15em'}}>
        ...
        <Grid item container direction='row' justify={matchesMD ? 'center' : undefined}>
          ...
          <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : undefined} style={{marginBottom: matchesMD ? '2.5em' : 0}}>
            <Grid item>
              <img src={yearbook} alt='yearbook of founder' style={{maxWidth: matchesMD ? 300 : undefined}}/>
            </Grid>
            <Grid item>
